...
class SocketIOOutput(OutputChannel):
    ...
    async def send_custom_json(
        ...
        try:
            ...
            json_message.setdefault("isGuideContext", False)
            ...
            json_message.setdefault("name_provided", False)
            json_message.setdefault("modal", {})
            json_message.setdefault("slider", {})
            json_message.setdefault("guideInfo", {})
            ...
            message = {
                ...
                "isGuideContext": json_message["isGuideContext"],
